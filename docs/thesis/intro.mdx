...
This thesis focuses on extending the open-source headless CMS, **Decap CMS**, to support **MDX** (Markdown + JSX), while also improving flexibility and usability for modern documentation and content workflows.
...
- The client’s existing documentation platform is built on Docusaurus, making it the natural choice for extending CMS capabilities and ensuring full compatibility with their current static site workflow.
